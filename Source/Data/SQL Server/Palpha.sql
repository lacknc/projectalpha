--  ----------------------------------------------------------------------------------------------------
--  Palpha Data Structures for SQL Server - Gbtc
--
...
--       Script is based on Palpha.sql script created by James Ritchie Carroll.
...
USE [master]
GO
CREATE DATABASE [Palpha];
GO
ALTER DATABASE [Palpha] SET ANSI_NULL_DEFAULT OFF 
GO
ALTER DATABASE [Palpha] SET ANSI_NULLS OFF 
GO
ALTER DATABASE [Palpha] SET ANSI_PADDING OFF 
GO
ALTER DATABASE [Palpha] SET ANSI_WARNINGS OFF 
GO
ALTER DATABASE [Palpha] SET ARITHABORT OFF 
GO
ALTER DATABASE [Palpha] SET AUTO_CLOSE OFF 
GO
ALTER DATABASE [Palpha] SET AUTO_CREATE_STATISTICS ON 
GO
ALTER DATABASE [Palpha] SET AUTO_SHRINK OFF 
GO
ALTER DATABASE [Palpha] SET AUTO_UPDATE_STATISTICS ON 
GO
ALTER DATABASE [Palpha] SET CURSOR_CLOSE_ON_COMMIT OFF 
GO
ALTER DATABASE [Palpha] SET CURSOR_DEFAULT  GLOBAL 
GO
ALTER DATABASE [Palpha] SET CONCAT_NULL_YIELDS_NULL OFF 
GO
ALTER DATABASE [Palpha] SET NUMERIC_ROUNDABORT OFF 
GO
ALTER DATABASE [Palpha] SET QUOTED_IDENTIFIER OFF 
GO
ALTER DATABASE [Palpha] SET RECURSIVE_TRIGGERS OFF 
GO
ALTER DATABASE [Palpha] SET  ENABLE_BROKER 
GO
ALTER DATABASE [Palpha] SET AUTO_UPDATE_STATISTICS_ASYNC OFF 
GO
ALTER DATABASE [Palpha] SET DATE_CORRELATION_OPTIMIZATION OFF 
GO
ALTER DATABASE [Palpha] SET TRUSTWORTHY OFF 
GO
ALTER DATABASE [Palpha] SET ALLOW_SNAPSHOT_ISOLATION OFF 
GO
ALTER DATABASE [Palpha] SET PARAMETERIZATION SIMPLE 
GO
ALTER DATABASE [Palpha] SET  READ_WRITE 
GO
ALTER DATABASE [Palpha] SET RECOVERY SIMPLE 
GO
ALTER DATABASE [Palpha] SET  MULTI_USER 
GO
ALTER DATABASE [Palpha] SET PAGE_VERIFY CHECKSUM  
GO
ALTER DATABASE [Palpha] SET DB_CHAINING OFF 
GO
-- The next three commented statements are used to create a user with access to the Palpha database.
...
--GO
--CREATE ROLE [PalphaManagerRole] AUTHORIZATION [dbo]
--GO
--EXEC sp_addrolemember N'PalphaManagerRole', N'NewUser'
--GO
--EXEC sp_addrolemember N'db_datareader', N'PalphaManagerRole'
--GO
--EXEC sp_addrolemember N'db_datawriter', N'PalphaManagerRole'
--GO
